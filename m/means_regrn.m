%
% The means by nonnegative linear regression. 
%

function [U,V] = means_regrn(T, m, n)
...
w_regrn = lsqnonneg(full([pred_e pred_u pred_v]), targ) 
...
U = .5 * w_regrn(1) * meane + w_regrn(2) * meanu;
V = .5 * w_regrn(1) * meane + w_regrn(3) * meanv;
